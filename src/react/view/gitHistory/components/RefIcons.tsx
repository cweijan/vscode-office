...
export function BranchRefIcon({ className }: RefIconProps) {
    return (
        <svg
            className={className}
...
export function TagRefIcon({ className }: RefIconProps) {
    return (
        <svg
            className={className}
            xmlns="http://www.w3.org/2000/svg"
...
export function StashRefIcon({ className }: RefIconProps) {
    return (
        <svg
            className={className}
            xmlns="http://www.w3.org/2000/svg"
